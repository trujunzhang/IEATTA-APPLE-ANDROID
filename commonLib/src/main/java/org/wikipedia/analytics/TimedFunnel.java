...
/*package*/public abstract class TimedFunnel extends Funnel {
    ...
    /*package*/public TimedFunnel(BaseApp app, String schemaName, int revision, int sampleRate) {
        this(app, schemaName, revision, sampleRate, null);
    }

    /*package*/public TimedFunnel(BaseApp app, String schemaName, int revision, int sampleRate, Site site) {
