...
/*package*/public abstract class Funnel {
    ...
    /*package*/
    public Funnel(BaseApp app, String schemaName, int revision) {
        this(app, schemaName, revision, SAMPLE_LOG_ALL);
    }

    /*package*/
    public Funnel(BaseApp app, String schemaName, int revision, @Nullable Site site) {
        this(app, schemaName, revision, SAMPLE_LOG_ALL, site);
    }

    /*package*/
    public Funnel(BaseApp app, String schemaName, int revision, int sampleRate) {
        this(app, schemaName, revision, sampleRate, null);
    }

    /*package*/
    public Funnel(BaseApp app, String schemaName, int revision, int sampleRate, @Nullable Site site) {
        this.app = app;
