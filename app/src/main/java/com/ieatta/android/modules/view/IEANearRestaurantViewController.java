...
//                    self.appendSectionTitleCell(SectionTitleCellModel(editKey: IEAEditKey.Section_Title, title: L10n.NearbyRestaurants.string), forSectionIndex: NearRestaurantSection.sectionRestaurants.rawValue)
                }
