...
//                 */
//                // Step04: Delete it.
//                return whTeam.deleteInBxxxackground();
//            }
//        }).onSuccessTask(new Continuation<Void, Task<Void>>() {
//            @Override
//            public Task<Void> then(Task<Void> task) throws Exception {
...
//                 */
//                // Step04: Delete it.
//                return whTeam.deleteIxxxnBackground();
//            }
//        }).onSuccessTask(new Continuation<Void, Task<Void>>() {
//            @Override
//            public Task<Void> then(Task<Void> task) throws Exception {
...
//                 */
//                // Step04: Delete it.
//                return whTeam.unpinInBackgroxxundWithNewRecord();
//            }
//        }).onSuccessTask(new Continuation<Void, Task<Void>>() {
//            @Override
//            public Task<Void> then(Task<Void> task) throws Exception {
...
//                 */
//                // Step04: Delete it.
//                return whTeam.unpinInBackgrouxxxndWithNewRecord();
//            }
//        }).onSuccessTask(new Continuation<Void, Task<Void>>() {
//            @Override
//            public Task<Void> then(Task<Void> task) throws Exception {
